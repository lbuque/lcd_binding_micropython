...
STATIC const mp_map_elem_t mp_module_lcd_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_RM67162),    (mp_obj_t)&lcd_rm67162_type        },
    { MP_ROM_QSTR(MP_QSTR_I8080),      (mp_obj_t)&lcd_i80_type            },
    { MP_ROM_QSTR(MP_QSTR_SPIPanel),   (mp_obj_t)&lcd_spi_panel_type      },
    { MP_ROM_QSTR(MP_QSTR_QSPIPanel),  (mp_obj_t)&lcd_qspi_panel_type     },
#if DPI_LCD_SUPPORTED
    { MP_ROM_QSTR(MP_QSTR_DPI),        (mp_obj_t)&lcd_dpi_type            },
#endif
