...
STATIC void mp_lcd_i80_print(const mp_print_t *print,
                             mp_obj_t          self_in,
...
STATIC mp_obj_t mp_lcd_i80_make_new(const mp_obj_type_t *type,
                                    size_t               n_args,
                                    size_t               n_kw,
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(mp_lcd_i80_tx_color_obj, 2, 3, mp_lcd_i80_tx_color);
